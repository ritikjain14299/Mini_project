...
from .models import Subjects, SessionYearModel, Students , \
     Staffs, CustomUser, Courses, NotificationStaffs, StudentResult, OnlineClassRoom ,\
     Question,Answer,Comment,UpVote,DownVote
...
def staff_home(request):
    ...
    return render(request,"staff_template/staff_home_template.html",{"students_count":students_count,"subject_count":subject_count})
...
def home(request):
    ...
    return render(request,'staff_template/home.html',{'quests':quests})
...
def detail(request,id):
    ...
    return render(request,'staff_template/detail.html',{
        'quest':quest,
        'tags':tags,
        'answers':answers,
        'answerform':answerform
...
def ask_form(request):
    ...
    return render(request,'staff_template/ask-question.html',{'form':form})
...
def tag(request,tag):
    ...
    page_num=request.GET.get('page',1)
    quests=paginator.page(page_num)
    return render(request,'staff_template/tag.html',{'quests':quests,'tag':tag})
...
def tags(request):
    ...
    return render(request,'staff_template/tags.html',{'tags':tag_with_count})
